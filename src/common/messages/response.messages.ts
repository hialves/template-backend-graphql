...
export const responseMessages = {
  ...
  sms: {
    verificationCode: (code: string, otpHash: string) => `Seu código de verificação GVBUS: ${code}\n\n${otpHash}`,
  ...
  role: {
    entity: 'Perfil',
    finalLetter: 'o',
    provideDates: 'Informe as datas de início e fim',
    provideDateInFuture: 'Informe uma data no futuro',
    provideDateGreaterThanStart: 'Informe uma data maior que o início',
    nameConflictError: 'Já existe um perfil com esse nome',
  },
  ...
  admin: {
    ...
    credentialsAndAdminId: 'Informe apenas as credenciais ou apenas o Administrador',
    credentialsNorAdminId: 'Informe as credenciais do novo Administrador ou o registro de um Administrador existente',
  },
